...
const Users = () => {
  ...
  const handleItemChange = (index, field, value) => {
    ...
    updatedItems[index][field] = field === "quantity" || field === "price" ? +value : value; // convert to number for quantity and price
  ...
  const addItem = () => {
    setItems([
      ...items,
      { id: items.length + 1, name: "", quantity: 1, price: 0 },
    ]);
  };
...
//       {/* Form for adding the first item */}
//       <div>
//         <input
//           type="text"
...
//           step="0.01"
//         />
//         <button onClick={handleAddNewItemButtonClick}>Add New Item</button>
//       </div>
...
//                       Download Sample Users CSV File
//                     </p>
//                     <DocumentDownload
//                       color="#4CAF50"
//                       variant="Bold"
