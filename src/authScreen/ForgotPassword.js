      ...
      <div className="bg-[#ffff] rounded-[16px] max-w-[628px] pt-[24px] md:pt-[32px]  pb-[24px] px-[40px] md:px-[60px] xl:px-[80px]">
        ...
        <form className="mt-[40px] max-w-[340px] md:max-w-[486px]">
          ...
          <Link to="/">
            <button
              type="button"
              className="text-[14px] text-[#F05800] font-medium leading-[20px] tracking-[0.2px] mb-[40px] mx-auto flex justify-center items-center"
            >
              <ArrowLeft size="18" color="#F05800" /> Back to Login
            </button>
          </Link>
