        ...
        <div className="px-[10px] py-[18px] rounded-lg bg-slate-100 text-[#667185] w-[85%] mx-auto">
          ...
          <ul className="gap-[8px] flex flex-col mt-4">
            ...
            <li className="flex-between ">
              ...
              <p className="text-[14px] leading-[14px] font-medium">{accountNumber}</p>
            </li>
            <li className="flex-between ">
            ...
            <li className="flex-between ">
              ...
              <p className="text-[14px] leading-[14px] font-medium">{purpose}</p>
            </li>
            <li className="flex-between ">
              <p className="text-[14px] leading-[14px] ">Date:</p>
              <p className="text-[14px] leading-[14px] font-medium">{getFormattedCurrentDay('short')}</p>
            </li>
            <li className="flex-col space-y-1 ">
              <p className="text-[14px] leading-[14px] ">Naration:</p>
              <p className="text-[14px] leading-[14px] font-medium">{naration}</p>
            </li>
