...
const RecentTransaction = () => {
    ...
    parameters: [
      {
        ...
        type: "string",
        description:
          "The transaction reference ID to filter specific transactions.",
        required: false,
      },
      {
        ...
        type: "string",
        description:
          "The status of the transaction (e.g., 'successful', 'failed').",
        required: false,
      },
      {
        ...
        type: "string",
        description:
          "The reason for the transaction, such as 'Payment via payment link'.",
        required: false,
      },
    ],
  });
  ...
  return (
    <div>
      {" "}
      <div className="bg-white rounded-lg border-[0.2px] border-[#98a2b3] mt-[40px]  w-full  mt">
