  ...
  return (
    <>
      ...
      <ModalFooter gap={"16px"}>
        ...
        <button onClick={handleOtp} className="border-[0.2px]  border-[#98A2B3] w-[99px] bg-[#26ae5f] flex banks-center justify-center text-center rounded-[8px] py-[12px] text-[14px] font-medium text-white">
